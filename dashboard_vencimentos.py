...
def carregar_e_consolidar_dados_sharepoint():
    try:
        # Debug: mostrar se secrets existem
        ...
        # CORREÇÃO: Construir URL completa com tenant
        authority_url = f"https://login.microsoftonline.com/{tenant_id}"
        
        # CORREÇÃO: Usar ClientCredential com tenant específico
        credentials = ClientCredential(client_id, client_secret)
        
        # CORREÇÃO: Especificar tenant na URL do site
